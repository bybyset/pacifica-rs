...
pub trait LogWriter {
    ...
    async fn truncate_prefix(&mut self, first_index_kept: u64) -> Result<(), AnyError>;

    /// Delete uncommitted logs from storage's tail, (last_index_kept, last_log_index] will be discarded.
    async fn truncate_suffix(&mut self, last_index_kept: u64) -> Result<(), AnyError>;
    ...
    async fn reset(&mut self, next_log_index: u64) -> Result<(), AnyError>;
